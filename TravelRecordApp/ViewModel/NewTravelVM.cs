...
namespace TravelRecordApp.ViewModel
{
    public class NewTravelVM : INotifyPropertyChanged
    {
        ...
        public async void PublishPost(Post post)
        {
            ...
            {
                await App.Current.MainPage.DisplayAlert(nre.ToString(), "Experience failed to be inserted", "Ok");
            }
            catch (Exception ex)
            {
                await App.Current.MainPage.DisplayAlert(ex.ToString(), "Experience failed to be inserted", "Ok");
            }
        }
